...
// import Lottie from '../assets/bus_lottie.json' // 로티 사용법 확인하기
  ...
  return (
      <div className="min-h-screen bg-navy-900 text-white flex">
        ...
        <div className="w-20 bg-navy-800 flex flex-col items-center py-6 space-y-8">
          ...
          <nav className="flex flex-col space-y-6">
            <button className="p-3 hover:bg-blue-900 rounded-lg transition-colors">
            ...
            <button className="p-3 hover:bg-blue-900 rounded-lg transition-colors">
              <img src={logoutIcon} alt="Home" className="w-6 h-6"/>
            </button>
          </nav>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="text-sm">v1.0.1 (beta)</div>
        <button
          onClick={handleLogout}
          className="bg-blue-900 px-4 py-2 rounded-md hover:bg-blue-800"
        >
          Logout
        </button>
      </header>
      ...
      <main className="p-8">
        <div className="flex items-center justify-center mb-12">
          <img src={busLogo} alt="Bus Logo" className="w-24 h-24" />
          <h1 className="text-2xl ml-4">오늘도, 당신의 안전을 지키는 이음새입니다.</h1>
        </div>

        <div className="bg-navy-800 p-6 rounded-lg mb-8">
        ...
        <p className="text-center text-sm">이음새 connection@office.kopo.ac.kr   ©2025 IEUMSAE Team.   All rights reserved.</p>

        {/* Team Members */}
        <div className="flex justify-center space-x-12 mt-8">
          {['CHA', 'MIN', 'HAN', 'SUN'].map((member) => (
